...
- `ht.indep`: hypothesis test for the comparison of two independent AUCs.
...
To install the most updated version of the package from GitHub run the following code:
